...
class CacheManager:
    ...
    def remove_from_favorites(self, index: int) -> Optional[Dict[str, Any]]:
        """Menghapus anime dari favorit berdasarkan indeks."""
    ...
    def update_last_episode_check(self, anime_url: str, episode_count: int):
        """Memperbarui jumlah episode terakhir untuk notifikasi."""
        self._cache[CACHE_KEY_LAST_EPISODE_CHECK][anime_url] = episode_count
        self.save()

    def get_stats(self) -> Dict[str, Any]:
        """Mengumpulkan statistik dari cache."""
        return {
    ...
    def clear_anime_details_cache(self):
        """Membersihkan cache detail anime."""
        self._cache[CACHE_KEY_ANIME_DETAILS] = {}
        self.save()

    def get_all_data(self) -> Dict[str, Any]:
        """Mengembalikan seluruh isi cache untuk keperluan ekspor."""
        return self._cache
